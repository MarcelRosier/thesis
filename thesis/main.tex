...
\newcommand*{\getTitle}{Image retrieval based brain tumor modeling}
\newcommand*{\getTitleGer}{Image-retrieval basierte Gehirntumormodellierung}
\newcommand*{\getAuthor}{Marcel Thomas Rosier}
\newcommand*{\getDoctype}{Bachelor's Thesis in Informatics}
\newcommand*{\getSupervisor}{Prof. Dr. Bjoern H. Menze}
\newcommand*{\getAdvisor}{M.Sc. Ivan Ezhov}
