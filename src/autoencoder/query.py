...
def run_query_for_encoded_data(real_tumor_id, use_stored_real_data=True, is_ae=True, is_1024=False, is_20k=False, is_hash_ae=False):
    ...
    if is_hash_ae:
        ...
        base_path_flair = f"/mnt/Drive3/ivan_marcel/final_encs/encoded_VAE_FLAIR_{'1024' if is_1024 else '8'}_{'20000' if is_20k else '1500'}"
        base_path_t1c = f"/mnt/Drive3/ivan_marcel/final_encs/encoded_VAE_T1C_{'1024' if is_1024 else '8'}_{'20000' if is_20k else '1500'}"
    # load real_tumor
