...
def run():
    ...
    model, result = train_tumort1c(latent_dim=1024, train_loader=train_loader,
                                   val_loader=val_loader, test_loader=test_loader)
    print("Finished Training")
    print(result)


def train_tumort1c(latent_dim, train_loader, val_loader, test_loader):
    ...
    model = Autoencoder(base_channel_size=16, latent_dim=latent_dim)
