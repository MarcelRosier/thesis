...
from constants import (IS_LOCAL, SYN_TUMOR_BASE_PATH_LOCAL, SYN_TUMOR_BASE_PATH_SERVER,
...
SYN_TUMOR_BASE_PATH = SYN_TUMOR_BASE_PATH_LOCAL if IS_LOCAL else SYN_TUMOR_BASE_PATH_SERVER
